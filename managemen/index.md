...
<!-- Top Navigation -->
	<div class="bprbkk-top clearfix">
		<a class="bprbkk-icon" href="/"><span>PD BPR BKK WONOGIRI</span></a>
		<span class="right"><a class="bprbkk-icon" href="/news"><span>Berita</span></a></span>
	</div>
<div class="content">
	<header class="bprbkk-header">
		<h1>Staf Manajemen <span>PD BPR BKK WONOGIRI</span></h1>
	...
	<h2>Kepala Bidang</h2>
		...
		<div class="tooltip tooltip-effect-3">
			...
			<span class="tooltip-content">Kepala Bidang Kepatuhan dan Manajemen Risiko PD BPR BKK WONOGIRI</span>
			<div class="tooltip-shape">
				<svg height="165px" width="220px">
				<use xlink:href="#managemen-2" class="bprbkk-1" />
				</svg>
	...
	<p class="info">Semua staf manajemen diatas bekerja di Kantor PD BPR BKK WONOGIRI</p>
